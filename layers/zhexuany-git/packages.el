(setq zhexuany-git-packages
      '(
        magit
        git-messenger
        ))
(defun zhexuany-git/post-init-magit ()
  (use-package magit
    :defer t
    :config
    (progn
    ...
    (progn
      ...
      (defun zhexuany-git/magit-visit-pull-request ()
      ...
      (eval-after-load 'magit
        '(define-key magit-mode-map (kbd "s-g")
           #'zhexuany-git/magit-visit-pull-request))
...
(defun zhexuany-git/post-init-git-messenger ()
